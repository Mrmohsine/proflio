...
const projectsDataFR = [
  ...
  {
    id: 2,
    title: "FoodieFlow — Gestion de restaurant",
    description:
  ...
  },
  {
    ...
    technologies: ["Firebase", "TailwindCSS"],
    image: affimg,
  },
];

// English projects data
const projectsDataEN = projectsDataFR.map((proj) => {
  const translations = {
    1: {
      title: "Foodie Flow - Landing Page",
      description:
        "Foodie Flow Landing Spark is a modern web landing page for the Foodie Flow project: it presents the main features, visuals of the app, and provides an attractive entry point for users and investors. Designed with special attention to user experience and design, this landing page highlights the brand and guides visitors to the main application.",
    },
    2: {
      title: "FoodieFlow — Restaurant Management",
      description:
        "FoodieFlow is a complete web solution for restaurant management: it allows managing menus, orders, reservations, and staff workflows. Whether you need a quick module for order taking or a full dashboard for kitchen and service management, FoodieFlow provides a smooth and modern interface. Deployed via React + Vite, it integrates into an evolving ecosystem and adapts to the operational reality of restaurants.",
    },
    3: {
      title: "AgenteClara — Landing Page",
      description:
        "The AgenteClara landing page is a modern and clean interface designed to present the concept, features, and vision of the AiCall project — an AI- and voice-based solution. This page highlights the key points of the product, grabs visitors’ attention, and efficiently guides them to the app or important information. Optimized for performance, SEO, and a smooth user experience.",
    },
    4: {
      title: "AgenteClara — Dashboard",
      description:
        "The AgenteClara dashboard is a modern interface for managing and supervising the activity of the AgenteClara platform. It provides a centralized view of calls, users, configurations, and real-time statistics. Designed to be fast, clear, and intuitive, this dashboard facilitates operational management thanks to a modern UI and optimized structure.",
    },
    5: {
      title: "Archaine",
      description:
        "This very lightweight mobile app built with Expo contains only two screens: a simple home page and a QR code scanning page. It demonstrates the use of React Native with Expo for basic navigation, camera access, and real-time scanning. It's a minimalist project, fast to load and perfect as a base to integrate scan or authentication features via QR code.",
    },
    6: {
      title: "School Landing Page",
      description:
        "A modern and responsive landing page for a school, developed with React, Vite, and Tailwind CSS. This project features a clean design with intuitive navigation, attractive hero sections, and interactive components to effectively present school information. Optimized for performance, it provides a solid foundation for developing complete educational sites.",
    },
    7: {
      title: "Dashboard Analytics",
      description:
        "An interactive dashboard developed with PHP and JavaScript, using AdminLTE to display DataTables and charts. It allows manipulating and visualizing real-time data from an API, providing a clear interface for analysis and monitoring of important information.",
    },
    8: {
      title: "Equipment Management",
      description:
        "A complete platform for managing all equipment purchased by a company (computers, scanners, tables, etc.). Each item is recorded in a DataTable with full CRUD operations, and a QR code is generated for each equipment with all its information, ready to be printed and attached.",
    },
    9: {
      title: "Commercial Website",
      description:
        "A full-featured website for a company, with a modern public-facing part for clients and an admin back-office allowing to modify all content: texts, images, colors, sections, and menus. Developed with PHP and JavaScript, it combines flexibility and easy administration to fully manage the site.",
    },
    10: {
      title: "Book Store",
      description:
        "A website dedicated to books where you can easily buy, read online, or download a wide variety of titles. Whether you are looking for the latest releases or timeless classics, our platform allows you to discover and access books you are passionate about from a single place. Enjoy a flexible reading experience adapted to your needs, with options for every type of reader.",
    },
    11: {
      title: "Affiliate website",
      description:
        "An affiliate website that allows you to discover and access the best offers and products from our partners. Whether you are looking for recommendations, exclusive promotions, or product comparisons, our platform guides you to the best options for shopping confidently. Enjoy a simplified user experience and expert advice to get the most out of your online purchases through our affiliate network.",
    },
  };

  return {
    ...proj,
    title: translations[proj.id]?.title || proj.title,
    description: translations[proj.id]?.description || proj.description,
  };
});

function Projects() {
  const { langData } = useLang();
  const projectsData = langData === "fr" ? projectsDataFR : projectsDataEN;
  ...
  return (
    <>
      <h1
        key={`projects-title-${langData}`}
        className="text-white text-4xl md:text-5xl lg:text-5xl text-center mt-20 font-bold"
      >
        {langData === "fr" ? "Projets" : "Projects"}
      </h1>

      {projectsData.map((project, index) => (
        <ProjectCard
          key={`${project.id}-${langData}`} 
          project={project}
