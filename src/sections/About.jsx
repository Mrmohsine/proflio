  ...
  return (
    <div className="mx-auto w-[90%] md:w-[80%] mt-20 grid gap-4 grid-cols-1 md:grid-cols-3 items-center">
      <div className="w-full space-y-3 col-span-2 flex flex-col justify-center h-auto">
        ...
        >
          Je suis un développeur full stack passionné, avec une solide
          expérience dans la création de sites web, de plateformes SaaS et de
          solutions métiers sur mesure. Je maîtrise les technologies front-end
          telles que HTML, CSS, JavaScript, React.js et TailwindCSS, ainsi que
          les technologies back-end comme PHP, MySQL,Laravel, Firebase, et
